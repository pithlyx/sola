...
extern "C" {
	...
	EXPORT void NativeSetCellularDistance2Indicies(POINTER, int, int);
	EXPORT void NativeSetCellularJitter(POINTER, float);
	...
	EXPORT void NativeSetPerturbNormaliseLength(POINTER, float);
