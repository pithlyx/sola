...
void NativeSetCellularDistance2Indicies(POINTER p, int cellularDistanceIndex0, int cellularDistanceIndex1)
{
	L_2_FNP(p)->SetCellularDistance2Indicies(cellularDistanceIndex0, cellularDistanceIndex1);
}

void NativeSetCellularJitter(POINTER p, float cellularJitter)
{
	L_2_FNP(p)->SetCellularJitter(cellularJitter);
}
...
void NativeSetPerturbNormaliseLength(POINTER p, float perturbNormaliseLength)
{
