...
public class FastNoiseSIMD
{
    ...
    {
        NativeSetCellularDistance2Indicies(
            nativePointer,
    ...
    public void FillSampledNoiseSet(
        float[] noiseSet,
        int xStart,
        int yStart,
        int zStart,
    ...
    public void FillNoiseSetVector(
        float[] noiseSet,
        VectorSet vectorSet,
        float xOffset = 0f,
        float yOffset = 0f,
    ...
    {
        NativeFillNoiseSetVector(
            nativePointer,
            noiseSet,
            vectorSet.nativePointer,
            xOffset,
            yOffset,
            zOffset
        );
    ...
    public void FillSampledNoiseSetVector(
        float[] noiseSet,
        VectorSet vectorSet,
        float xOffset = 0f,
        float yOffset = 0f,
    ...
    {
        NativeFillSampledNoiseSetVector(
            nativePointer,
            noiseSet,
            vectorSet.nativePointer,
            xOffset,
    ...
    public float[] GetSampledNoiseSet(
        int xStart,
        int yStart,
        int zStart,
        int xSize,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void NativeSetAxisScales(
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void NativeSetCellularDistanceFunction(
        POINTER nativePointer,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void NativeSetCellularNoiseLookupType(
        POINTER nativePointer,
        int noiseType
    );

    [DllImport(NATIVE_LIB)]
    private static extern void NativeSetCellularNoiseLookupFrequency(
        POINTER nativePointer,
        float freq
    );

    [DllImport(NATIVE_LIB)]
    private static extern void NativeSetCellularDistance2Indicies(
        POINTER nativePointer,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void NativeSetPerturbFractalOctaves(
        POINTER nativePointer,
        int perturbOctaves
    );

    [DllImport(NATIVE_LIB)]
    private static extern void NativeSetPerturbFractalLacunarity(
        POINTER nativePointer,
        float perturbFractalLacunarity
    );

    [DllImport(NATIVE_LIB)]
    private static extern void NativeSetPerturbFractalGain(
        POINTER nativePointer,
        float perturbFractalGain
    );

    [DllImport(NATIVE_LIB)]
    private static extern void NativeSetPerturbNormaliseLength(
        POINTER nativePointer,
        float perturbNormaliseLength
    );

    [DllImport(NATIVE_LIB)]
    private static extern void NativeFillNoiseSet(
        POINTER nativePointer,
        float[] noiseSet,
        int xStart,
        int yStart,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void NativeFillSampledNoiseSet(
        POINTER nativePointer,
        float[] noiseSet,
        int xStart,
        int yStart,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void NativeFillNoiseSetVector(
        POINTER nativePointer,
        float[] noiseSet,
        POINTER vectorSetPointer,
        float xOffset,
        float yOffset,
        float zOffset
    );
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void NativeFillSampledNoiseSetVector(
        POINTER nativePointer,
        float[] noiseSet,
        POINTER vectorSetPointer,
        float xOffset,
    ...
    private static void NativeSetAxisScales(
        POINTER nativePointer,
        float xScale,
        float yScale,
        float zScale
    ...
    private static void NativeSetCellularDistanceFunction(
        POINTER nativePointer,
        int distanceFunction
    ) { }
    ...
    private static void NativeSetCellularDistance2Indicies(
        POINTER nativePointer,
        int cellularDistanceIndex0,
        int cellularDistanceIndex1
    ) { }
    ...
    private static void NativeSetPerturbFractalOctaves(
        POINTER nativePointer,
        int perturbOctaves
    ) { }

    private static void NativeSetPerturbFractalLacunarity(
        POINTER nativePointer,
        float perturbFractalLacunarity
    ) { }

    private static void NativeSetPerturbFractalGain(
        POINTER nativePointer,
        float perturbFractalGain
    ) { }

    private static void NativeSetPerturbNormaliseLength(
        POINTER nativePointer,
        float perturbNormaliseLength
    ) { }

    private static void NativeFillNoiseSet(
        POINTER nativePointer,
        float[] noiseSet,
        int xStart,
        int yStart,
    ...
    private static void NativeFillSampledNoiseSet(
        POINTER nativePointer,
        float[] noiseSet,
        int xStart,
        int yStart,
    ...
    private static void NativeFillNoiseSetVector(
        POINTER nativePointer,
        float[] noiseSet,
        POINTER vectorSetPointer,
        float xOffset,
    ...
    private static void NativeFillSampledNoiseSetVector(
        POINTER nativePointer,
        float[] noiseSet,
        POINTER vectorSetPointer,
        float xOffset,
    ...
    public class VectorSet
    {
        ...
        )
        {
            ...
            nativePointer = NewVectorSet(
                vectorSetArray,
                vectorSetArray.Length,
                samplingScale,
                sampleSizeX,
                sampleSizeY,
                sampleSizeZ
...
#if UNITY_STANDALONE || UNITY_ANDROID || UNITY_IOS
        [DllImport(NATIVE_LIB)]
        private static extern POINTER NewVectorSet(
...
#else
        private static POINTER NewVectorSet(
            float[] vectorSetArray,
            int arraySize,
            int samplingScale,
            int sampleSizeX,
