...
public class FastNoiseSIMDUnity : MonoBehaviour
{
    ...
    public FastNoiseSIMD.CellularDistanceFunction cellularDistanceFunction = FastNoiseSIMD
        .CellularDistanceFunction
        .Euclidean;
    public FastNoiseSIMD.CellularReturnType cellularReturnType = FastNoiseSIMD
        .CellularReturnType
        .Distance;
    ...
    {
        // get noise set from fastnoiseSIMD and cast it to a float list
        List<float> noiseSet = new List<float>(
            fastNoiseSIMD.GetNoiseSet(xStart, yStart, zStart, xSize, ySize, zSize, scaleModifier)
        );
        return noiseSet;
    }
}
