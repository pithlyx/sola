...
public class Chunk
{
    public Vector3Int chunkPosition; // The origin of the chunk in world coordinates
    ...
    public Chunk(int size, Vector3Int chunkOrigin, Resource[,] resourceArray)
    {
        ...
        this.chunkPosition = chunkOrigin; // Set the origin of the chunk in world coordinates
    ...
    public Vector3Int GetTilePosition(int localX, int localY)
    {
        ...
        return new Vector3Int(
            localX + (chunkPosition.x * chunkSize),
            localY + (chunkPosition.y * chunkSize),
            0
        );
    }
